...
public class UpdateProfesseurController implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        nom.setText(ProfesseurController.selectedItem.getNom());
        prenom.setText(ProfesseurController.selectedItem.getPrenom());
        cin.setText(ProfesseurController.selectedItem.getCin());
        phone.setText(ProfesseurController.selectedItem.getTelephone());
        address.setText(ProfesseurController.selectedItem.getAddress());
        email.setText(ProfesseurController.selectedItem.getEmail());
        dateR.setValue(ProfesseurController.selectedItem.getDate_recrutement());
    ...
    public void updateProfesseur(ActionEvent actionEvent) {
        ...
        try {
            metier.updateProfesseur(ProfesseurController.selectedItem,p);
            ...
            alert.setContentText("Le professeur "+Nom+" "+Prenom+" a été modifé avec succès!");
            alert.show();
